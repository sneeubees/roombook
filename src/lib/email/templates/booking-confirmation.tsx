...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; background: #f9fafb; padding: 40px 20px;">
  <div style="max-width: 500px; margin: 0 auto; background: #fff; border-radius: 8px; border: 1px solid #e5e7eb; padding: 32px;">
    <h2 style="margin: 0 0 8px; color: #111;">Booking Confirmed</h2>
    <p style="margin: 0 0 24px; color: #6b7280; font-size: 14px;">Hi ${props.userName}, your room booking has been confirmed.</p>
    ...
    <div style="background: #f3f4f6; border-radius: 6px; padding: 16px; margin-bottom: 24px;">
      <table style="width: 100%; font-size: 14px; border-collapse: collapse;">
        ...
        <tr>
          <td style="padding: 4px 0; color: #6b7280;">Rate</td>
          <td style="padding: 4px 0; text-align: right; font-weight: 600;">${props.rate}</td>
        </tr>
        ${props.description ? `<tr>
          <td style="padding: 4px 0; color: #6b7280;">Description</td>
          <td style="padding: 4px 0; text-align: right; font-weight: 600;">${props.description}</td>
        </tr>` : ""}
      </table>
    </div>
